...
> [!WARNING]
> Running this extension directly from source is no longer supported.
> Due to the new Autodarts authentication requirements and repeated Autodarts Terms of Service violations, this method is no longer possible.
